-- =============================================================================
-- Busca global: apenas itens em aberto (não concluídos)
-- Itens finalizados ficam só na busca local do menu Finalizados.
-- =============================================================================
...
comment on function public.buscar_conteudo(text, integer) is
  'Busca global case/accent-insensitive em itens abertos; respeita RLS (security invoker).';
